...
3) Никита Лагода - создание модуля логирования, написание серверной части для обмена данными с модулем, который подключает пользователь, логирование в ноутбуке с примером обучения нейросети, асинхронная работа бота и серверной части для взаимодействия с модулем логирования.
4) Валерия Смирнова - прописаны сценарии пользовательского взаимодействия с ботом, составлена структура связей пользовательского поведения с серверной частью, в базу данных добавлены мемы.
